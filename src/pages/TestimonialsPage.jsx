  ...
  return (
    <div className="pt-32 pb-20 relative">
      <div className="container mx-auto px-6 max-w-6xl text-center mb-16 relative z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-bold font-display tracking-tight mb-4" style={{ color: '#1A3344' }}>
          Client Feedback
        </h1>
        <p className="text-sm md:text-base max-w-xl mx-auto font-light" style={{ color: '#6A8A9A' }}>
