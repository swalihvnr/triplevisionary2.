      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-light tracking-wider" style={{ color: '#ffffff' }}>
            ASSET <span className="font-bold" style={{ color: '#4772b3' }}>LIBRARY</span>
          </h1>
        ...
        {/* Filter Tabs */}
        <div className="flex flex-wrap gap-2 mb-8 pb-4" style={{ borderBottom: '1px solid #4d4d4d' }}>
          {softwareList.map((software) => (
            <button
              ...
              style={{
                background: activeFilter === software ? '#4772b3' : '#363636',
                borderColor: activeFilter === software ? '#4772b3' : '#4d4d4d',
                color: activeFilter === software ? '#fff' : '#cccccc',
                boxShadow: activeFilter === software ? '0 2px 10px rgba(71,114,179,0.3), inset 0 1px 0 rgba(255,255,255,0.1)' : 'none',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredAssets.length > 0 ? (
            filteredAssets.map((asset) => {
              ...
              return (
                <div
                  ...
                  style={{
                    borderColor: isSelected ? '#4772b3' : undefined,
                    boxShadow: isSelected ? '0 0 0 2px #4772b3, 0 8px 30px rgba(71,114,179,0.15)' : undefined,
                  }}
                >
                  <div className="relative z-10">
                    <div className="flex justify-between items-start mb-2">
                      <h2 className="text-lg font-bold truncate pr-2" style={{ color: '#4772b3' }}>{asset.software}</h2>
                      <span className="text-xs rounded-full whitespace-nowrap font-bold"
                        style={{ background: '#3d3d3d', border: '1px solid #4d4d4d', color: '#cccccc', padding: '2px 8px' }}>
                        {asset.year}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-sm font-mono rounded-full font-bold"
                        style={{ color: '#4772b3', background: 'rgba(71,114,179,0.1)', border: '1px solid rgba(71,114,179,0.3)', padding: '2px 8px' }}>
                        {asset.extension}
                      </span>
                    </div>

                    <div className="flex justify-between items-center mt-4 pt-3" style={{ borderTop: '1px solid #3d3d3d' }}>
                      <div />
                      <a
            ...
            <div className="col-span-full text-center py-12" style={{ color: '#cccccc' }}>
              No assets found for <span className="font-bold" style={{ color: '#4772b3' }}>{activeFilter}</span>
            </div>
          )}
        </div>
      </div>
