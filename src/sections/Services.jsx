...
export default function Services() {
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(180deg, #1d1d1d 0%, #303030 50%, #1d1d1d 100%)',
        borderTop: '1px solid #4d4d4d',
        borderBottom: '1px solid #4d4d4d',
      }}
    >
      <div className="absolute top-0 right-1/4 w-[400px] h-[400px] rounded-full blur-[100px] pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(71,114,179,0.08), transparent)' }} />
      <div className="absolute bottom-0 left-1/4 w-[300px] h-[300px] rounded-full blur-[80px] pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(71,114,179,0.1), transparent)' }} />
            ...
            return (
              <motion.div key={service.title} variants={cardVariants} className="group">
                <GlassCard
                  ...
                  glowColor="rgba(71,114,179,0.12)"
                >
                  <div className="relative z-10">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-xs leading-relaxed font-light" style={{ color: '#cccccc' }}>
                        {service.desc}
                      </p>
                    </div>
                  </div>
