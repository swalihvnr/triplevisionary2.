        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          {feedback.map((item) => (
            ...
            >
              ...
              >
                <div className="flex items-center justify-between pb-4 mb-4" style={{ borderBottom: '1px solid #2c2c2e' }}>
                  <div className="flex items-center gap-3">
                    <div
                      className="w-10 h-10 rounded-lg flex items-center justify-center font-display text-[10px] font-bold"
                      style={{
                        background: '#1c1c1f',
                    ...
                    <div>
                      ...
                      <span className="text-[9px] block" style={{ color: '#68686f' }}>{item.role}</span>
                    </div>
                  </div>
                  <Quote size={16} style={{ color: '#38383a' }} />
                </div>

                <div className="flex gap-1 mb-4" style={{ color: '#007aff' }}>
                ...
                <div className="mt-6 pt-3 flex items-center justify-between text-[9px] font-display" style={{ borderTop: '1px solid #2c2c2e', color: '#68686f' }}>
                  <span className="font-bold">Verified Review</span>
                  <span className="font-bold" style={{ color: '#c7c7cc' }}>{item.company}</span>
                </div>
              </GlassCard>
            </motion.div>
          ))}
